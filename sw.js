...
self.addEventListener('fetch', event => {
  ...
  if(['/app.js','/style.css','/sw.js','/mobile-fixes.css','/mobile-public-profile.js','/visitor-profile-mobile-fix.js','/operator-guardian-fix.js','/operator-safe-client.js'].includes(url.pathname)){event.respondWith(fetch(event.request,{cache:'no-store'}));return;}
